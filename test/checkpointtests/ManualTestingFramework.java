...
public class ManualTestingFramework {
  ...
  public static void main(String[] args) {
    ...
    // dir>/manualTestInput.txt
    // and an output of <root project dir>/manualTestOutput.txt, with a
    // delimiter of ','
    //
    //
    // Helpful hint: the working directory of this program is <root project
    // dir>,
    // so you can refer to the files just using the INPUT/OUTPUT constants. You
    // do not
